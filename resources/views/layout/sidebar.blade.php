            ...
            <ul class="menu-inner py-1">
               ...
               <li class="menu-item {{ request()->routeIs('dashboard') ? 'active' : '' }}">
                  <a href="{{ route('dashboard') }}" class="menu-link">
                     ...
                     <div class="text-truncate">નિયંત્રણ પેનલ</div>
                  </a>
               </li>
               ...
               <li class="menu-item {{ request()->routeIs('purchase') ? 'active' : '' }}">
                  <a href="{{ route('purchase') }}" class="menu-link">
                     ...
                     <div class="text-truncate">ખરીદી</div>
                  </a>
               </li>
               ...
               <li class="menu-item {{ request()->routeIs('sales') ? 'active' : '' }}">
                  <a href="{{ route('sales') }}" class="menu-link">
                     ...
                     <div class="text-truncate">વેચાણ</div>
                  </a>
               </li>
               ...
               <li class="menu-item {{ request()->routeIs('customer_list') ? 'active' : '' }}">
                  <a href="{{ route('customer_list') }}" class="menu-link">
                     ...
                     <div class="text-truncate">ગ્રાહકોની યાદી</div>
                  </a>
               </li>

               <li class="menu-item {{ request()->routeIs('supplier_list') ? 'active' : '' }}">
                  ...
                  <ul class="navbar-nav flex-row align-items-center ms-md-auto">
                     ...
                     <li class="nav-item navbar-dropdown dropdown-user dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                           ...
                           <li>
                              <a class="dropdown-item" href="{{ route('admin.logout') }}" id="logoutBtn">
